/**
 * Migration Script: Add hypotheekverstrekkers to pensioen_uitvoerders
 * Run with: node scripts/run-migration-012.cjs
 */
...
async function runMigration() {
    ...
    try {
        ...
        // Read migration file
        const migrationPath = path.join(__dirname, '012_add_hypotheekverstrekkers.sql');
        console.log(`📄 Reading migration file: 012_add_hypotheekverstrekkers.sql`);
