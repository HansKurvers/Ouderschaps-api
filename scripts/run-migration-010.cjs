/**
 * Migration Script: Create pensioen_uitvoerders tables and seed data
 * Run with: node scripts/run-migration-010.cjs
 */
...
async function runMigration() {
    ...
    try {
        ...
        // Read migration file
        const migrationPath = path.join(__dirname, '010_create_pensioen_uitvoerders.sql');
        console.log(`📄 Reading migration file: 010_create_pensioen_uitvoerders.sql`);
